...
main(int argc, char *argv[])
{
  ...
  27:	6a 02                	push   $0x2
  29:	e8 05 04 00 00       	call   433 <printf>
    exit();
  2e:	e8 a6 02 00 00       	call   2d9 <exit>
  }
  ...
  68:	e8 df 00 00 00       	call   14c <strcpy>
   for(int i = 0; i < job_count; i++)
  ...
  8f:	7e ed                	jle    7e <main+0x7e>
    ...
    setpri(getpid(), 3);
  91:	e8 c3 02 00 00       	call   359 <getpid>
  96:	83 ec 08             	sub    $0x8,%esp
  99:	6a 03                	push   $0x3
  9b:	50                   	push   %eax
  9c:	e8 e8 02 00 00       	call   389 <setpri>
  ...
  ae:	68 46 07 00 00       	push   $0x746
  b3:	6a 02                	push   $0x2
  b5:	e8 79 03 00 00       	call   433 <printf>
        exit();
  ba:	e8 1a 02 00 00       	call   2d9 <exit>
      }
      if(np[i]->pid == 0)
      {
        if(exec(job[0], job) < 0)
  ...
  c2:	68 57 07 00 00       	push   $0x757
  c7:	6a 02                	push   $0x2
  c9:	e8 65 03 00 00       	call   433 <printf>
  ce:	83 c4 10             	add    $0x10,%esp
  d1:	eb 58                	jmp    12b <main+0x12b>
        exit();
      }
      else
      {
        ...
        wait();
  d3:	e8 09 02 00 00       	call   2e1 <wait>
    for(int i = 0; i < job_count ; i++)
  d8:	83 c3 01             	add    $0x1,%ebx
  db:	39 f3                	cmp    %esi,%ebx
  dd:	7d 51                	jge    130 <main+0x130>
      np[i]->pid = fork2(0);
  df:	8b bc 9d e8 fd ff ff 	mov    -0x218(%ebp,%ebx,4),%edi
  e6:	83 ec 0c             	sub    $0xc,%esp
  e9:	6a 00                	push   $0x0
  eb:	e8 89 02 00 00       	call   379 <fork2>
  f0:	89 47 10             	mov    %eax,0x10(%edi)
      printf(1, "np[%d]->pid = %d\n", i, np[i]->pid);
  f3:	50                   	push   %eax
  f4:	53                   	push   %ebx
  f5:	68 34 07 00 00       	push   $0x734
  fa:	6a 01                	push   $0x1
  fc:	e8 32 03 00 00       	call   433 <printf>
      if(np[i]->pid < 0) {
 101:	8b 47 10             	mov    0x10(%edi),%eax
 104:	83 c4 20             	add    $0x20,%esp
 107:	85 c0                	test   %eax,%eax
 109:	78 a0                	js     ab <main+0xab>
      if(np[i]->pid == 0)
 10b:	85 c0                	test   %eax,%eax
 10d:	75 c4                	jne    d3 <main+0xd3>
        if(exec(job[0], job) < 0)
 10f:	83 ec 08             	sub    $0x8,%esp
 112:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
 118:	50                   	push   %eax
 119:	ff b5 e8 fe ff ff    	pushl  -0x118(%ebp)
 11f:	e8 ed 01 00 00       	call   311 <exec>
 124:	83 c4 10             	add    $0x10,%esp
 127:	85 c0                	test   %eax,%eax
 129:	78 94                	js     bf <main+0xbf>
        exit();
 12b:	e8 a9 01 00 00       	call   2d9 <exit>
    //      setpri(np[j]->pid, 0);
 ...
 130:	bb 00 00 00 00       	mov    $0x0,%ebx
 135:	eb 08                	jmp    13f <main+0x13f>
    {
      wait();
 137:	e8 a5 01 00 00       	call   2e1 <wait>
    for(int i = 0; i < user_timeslice; i++)
 13c:	83 c3 01             	add    $0x1,%ebx
 13f:	3b 9d e4 fd ff ff    	cmp    -0x21c(%ebp),%ebx
 145:	7c f0                	jl     137 <main+0x137>
    //     printf(1, "Ticks: %d\n", ps.ticks[i][j]);
    //     printf(1, "Qtail: %d\n", ps.qtail[i][j]);
    //   }    
    // }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f7:	0f b6 92 6c 07 00 00 	movzbl 0x76c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 533:	75 28                	jne    55d <printf+0x12a>
          s = "(null)";
 535:	be 65 07 00 00       	mov    $0x765,%esi
...
free(void *ap)
{
 ...
 5a8:	a1 10 0a 00 00       	mov    0xa10,%eax
 ...
 5e4:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e6:	a3 10 0a 00 00       	mov    %eax,0xa10
}
 5eb:	5b                   	pop    %ebx
 5ec:	5e                   	pop    %esi
 5ed:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 643:	e8 54 ff ff ff       	call   59c <free>
  return freep;
 648:	a1 10 0a 00 00       	mov    0xa10,%eax
...
malloc(uint nbytes)
{
 ...
 66c:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 66f:	8b 0d 10 0a 00 00    	mov    0xa10,%ecx
 ...
 67b:	eb 4d                	jmp    6ca <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 67d:	c7 05 10 0a 00 00 14 	movl   $0xa14,0xa10
 684:	0a 00 00 
 687:	c7 05 14 0a 00 00 14 	movl   $0xa14,0xa14
 68e:	0a 00 00 
    base.s.size = 0;
 691:	c7 05 18 0a 00 00 00 	movl   $0x0,0xa18
 698:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 69b:	b9 14 0a 00 00       	mov    $0xa14,%ecx
 ...
 6ae:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6b1:	89 0d 10 0a 00 00    	mov    %ecx,0xa10
      return (void*)(p + 1);
 ...
 6cf:	73 d1                	jae    6a2 <malloc+0x46>
    if(p == freep)
 6d1:	39 05 10 0a 00 00    	cmp    %eax,0xa10
